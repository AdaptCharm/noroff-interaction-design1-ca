...
import { ThemeWidget, ShoppingCart } from '@components/common'
                ...
                <div className="flex items-center justify-start">
                  <div className="flex items-center gap-x-2">
                    <div className="relative">
                      ...
                      >
                        <Popover.Button
                          className="flex items-center justify-center bg-transparent rounded-lg w-10 h-10 border-none transition ease-default duration-400 text-black dark:text-white hover:p-2 hover:shadow-small focus:outline-none focus:ring-transparent"
                          ref={showRef}
                        >
